...
namespace BehaviorsOfConcern.Api.Infrastructure {
    public abstract class BasicAuthenticationAttribute : Attribute, IAuthenticationFilter {
        ...
        public async Task AuthenticateAsync(HttpAuthenticationContext context, CancellationToken cancellationToken) {
            ...
            /*removed Jun2017, let subclass determine what to do with 'authorization.Parameter'*/
            /*
        ...
        */
        ...
        protected abstract Task<IPrincipal> AuthenticateAsync(string authorizationParameter,
            CancellationToken cancellationToken);
